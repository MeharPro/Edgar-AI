  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="mx-auto max-w-md px-4 sm:px-6 lg:px-8 py-24">
        ...
        <p className="mt-2 text-white/70">Starter plan is free. Use your Google account to create your workspace.</p>
        <div className="mt-8">
          <button
        ...
        <p className="mt-4 text-xs text-white/60">You&apos;ll be redirected to Google to authenticate.</p>
      </div>
      <div className="fixed bottom-4 left-0 right-0 text-center">
        <a href="/tos" className="text-xs text-white/60 hover:text-white underline">Terms of Service</a>
      </div>
    </div>
  );
}
